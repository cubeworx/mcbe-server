...
INTERNET_TEST_STRING=${INTERNET_TEST_STRING:-"Minecraft"}
INTERNET_TEST_URL=${INTERNET_TEST_URL:-"https://playerdb.co"}
...
PLAYER_LOOKUP_URL=${PLAYER_LOOKUP_URL:-"https://playerdb.co/api/player/xbox"}
